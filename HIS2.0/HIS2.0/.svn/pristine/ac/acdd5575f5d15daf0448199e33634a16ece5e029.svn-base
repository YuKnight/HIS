    ...
    public partial class Frmbrxxcx : Form
    {
        ...
        private void butnew_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //Modify by jchl 2017-04-25 切换新His直连方式
                ...
                MethodInfo method = type.GetMethod("ShowDialog", new Type[0]);
                object frm = type.Assembly.CreateInstance(type.FullName, true, BindingFlags.CreateInstance, null, new object[] { "建档", "建档", 3 }, null, null); //Activator.CreateInstance(type); //
        ...
        private void Frmbrxxcx_Activated(object sender, EventArgs e)
        {
            if (_menuTag.Function_Name == "Fun_ts_mz_kgl_kdj")
            {
                ...
                //Modify by jchl 武汉中心医院默认选中全部登记员
