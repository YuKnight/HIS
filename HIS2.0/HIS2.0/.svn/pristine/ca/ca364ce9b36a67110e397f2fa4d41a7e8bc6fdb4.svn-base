...
namespace ts_yk_cgrk
{
	...
	/// Frmyprk 药品采购入库明细录入
	/// </summary>
	public class Frmyprk : System.Windows.Forms.Form
	{
        ...
        private System.Windows.Forms.DateTimePicker dtpxq;//; System.Windows.Forms.DateTimePicker dtpxqReal;
		...
		private System.Windows.Forms.DataGridTextBoxColumn col_批发价;
		private System.Windows.Forms.DataGridTextBoxColumn col_零售价;
        ...
        private System.Windows.Forms.DataGridTextBoxColumn col_加成率;
        ...
        bool bypth = false; //是否是退货
        bool bmrjj_cgrk = false;//采购入库默认进价
        private bool btjhj = false;
        private DataGridTextBoxColumn col_原进价;
        private DataGridTextBoxColumn col_调进货金额;
        private DataGridTextBoxColumn col_调零售金额;//是否调进货价
		...
		public Frmyprk(MenuTag menuTag,string chineseName,Form mdiParent,DataTable tb)
		{
            try
            {
                //
                ...
                if (_menuTag.Function_Name == "Fun_ts_yk_cgrk_th" || _menuTag.Function_Name == "Fun_ts_yk_cgrk_th_yf") //是否是退货
                    bypth = true;
                _tb = tb;
		...
		private void InitializeComponent()
		{
            ...
            this.col_批发价 = new System.Windows.Forms.DataGridTextBoxColumn();
            this.col_零售价 = new System.Windows.Forms.DataGridTextBoxColumn();
            this.col_加成率 = new System.Windows.Forms.DataGridTextBoxColumn();
            this.dataGridTextBoxColumn11 = new System.Windows.Forms.DataGridTextBoxColumn();
            this.dataGridTextBoxColumn9 = new System.Windows.Forms.DataGridTextBoxColumn();
            this.dataGridTextBoxColumn10 = new System.Windows.Forms.DataGridTextBoxColumn();
            this.col_调进货金额 = new System.Windows.Forms.DataGridTextBoxColumn();
            this.col_调零售金额 = new System.Windows.Forms.DataGridTextBoxColumn();
            ...
            this.label17.Location = new System.Drawing.Point(810, 43);
            ...
            this.txtshdh.Location = new System.Drawing.Point(629, 90);
            ...
            this.groupBox2.Controls.Add(this.txtkl);
            ...
            this.dtpxq.Location = new System.Drawing.Point(406, 90);
            this.dtpxq.Name = "dtpxq";
            this.dtpxq.Size = new System.Drawing.Size(133, 21);
            ...
            this.butmodif.Location = new System.Drawing.Point(893, 90);
            ...
            this.butdel.Location = new System.Drawing.Point(821, 90);
            ...
            this.butadd.Location = new System.Drawing.Point(749, 90);
            ...
            this.txtkl.Location = new System.Drawing.Point(504, 65);
            this.txtkl.Name = "txtkl";
            this.txtkl.Size = new System.Drawing.Size(56, 21);
            this.txtkl.TabIndex = 12;
            ...
            this.label32.Location = new System.Drawing.Point(470, 67);
            ...
            this.butph.Location = new System.Drawing.Point(310, 90);
            ...
            // label30
            // 
            this.label30.Location = new System.Drawing.Point(349, 94);
            ...
            this.txtph.Location = new System.Drawing.Point(231, 90);
            ...
            // label29
            // 
            this.label29.Location = new System.Drawing.Point(199, 90);
            ...
            this.col_批次号.ReadOnly = true;
            this.col_批次号.Width = 105;
            // 
            // col_kcid
            // 
            ...
            // 
            this.col_批发价.Format = "";
            this.col_批发价.FormatInfo = null;
            this.col_批发价.HeaderText = "批发价";
            this.col_批发价.NullText = "";
            this.col_批发价.ReadOnly = true;
            this.col_批发价.Width = 0;
            // 
            // col_零售价
            // 
            this.col_零售价.Format = "";
            this.col_零售价.FormatInfo = null;
            this.col_零售价.HeaderText = "零售价";
            this.col_零售价.NullText = "";
            this.col_零售价.ReadOnly = true;
            this.col_零售价.Width = 55;
            // 
            // col_加成率
            // 
            this.col_加成率.Format = "";
            this.col_加成率.FormatInfo = null;
            this.col_加成率.HeaderText = "加成率";
            this.col_加成率.NullText = "";
            this.col_加成率.Width = 50;
            // 
            ...
            // col_调进货金额
            // 
            this.col_调进货金额.Format = "";
            this.col_调进货金额.FormatInfo = null;
            this.col_调进货金额.HeaderText = "调进货金额";
            this.col_调进货金额.Width = 0;
            // 
            // col_调零售金额
            // 
            this.col_调零售金额.Format = "";
            this.col_调零售金额.FormatInfo = null;
            this.col_调零售金额.HeaderText = "调零售金额";
            this.col_调零售金额.Width = 0;
            // 
            // col_扣率
            // 
            this.col_扣率.Format = "";
		...
		private void Frmyprk_Load(object sender, System.EventArgs e)
		{
			try
			{
                ...
                || _menuTag.Function_Name == "Fun_ts_yk_cgrk_th_cx" || _menuTag.Function_Name == "Fun_ts_yk_cgrk_th_yf_cx")
                {
                ...
                //Modify by : jchl，自动分配批号的退货单单据不能改扣率及效期--ywlx:002
                if (_menuTag.FunctionTag.Trim().Equals("002"))
                {
                    txtkl.ReadOnly = true;
                    dtpxq.Enabled = false;
                }
		...
		private void csyp(int ggid,int cjid)
		{
            ...
            if (btjhj)
            {
                txtjj.Text = ydcj.MRJJ.ToString();
                txtjj.Tag = ydcj.MRJJ;
            }

            //if (btjhj)//调进货价
            //{
            //    txtjj.Text = ydcj.MRJJ.ToString("0.00");//默认进价
		...
		private void Fillrow(System.Data.DataRow row)
		{
            ...
            if (_menuTag.Function_Name == "Fun_ts_yk_cgrk_th_yf" || _menuTag.Function_Name == "Fun_ts_yk_cgrk_yf") //药房业务
            {
                ...
                if (bpcgl && bypth)
                {
                    ...
                    ////如果管理批次且退货，提示该物品不属于该单位
                    //int t_deptid = Convert.ToInt32(Convertor.IsNull(cmbck.SelectedValue, "0"));
                    //int t_ghdw=Yppc.SeekGhdwByKcid(t_kcid, t_deptid, InstanceForm.BDatabase);

                    //int tt_ghdw = Convert.ToInt32(Convertor.IsNull(this.txtghdw.Tag,"0"));
                    //if (tt_ghdw != 0&&t_ghdw!=0)
                    //{
                    //    if (tt_ghdw != t_ghdw)
                    //    {
                    //        string s_ghdw = Yp.SeekGhdw(t_ghdw, InstanceForm.BDatabase);
                    //        string ss_ghdw = Yp.SeekGhdw(tt_ghdw, InstanceForm.BDatabase);
                    //        if (MessageBox.Show(string.Format("该药品是从 {0} 采购的,您确认继续？", s_ghdw), "提示", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2) != DialogResult.No)
                    //        {
                    //            return;
                    //        }
                    //    }
            ...
            else//药库业务
            {
                ...
                if (bpcgl && bypth)
                {
                    ...
                    //如果管理批次且退货，提示该物品不属于该单位
                    string yppch=txtpch.Text;
                    int t_deptid = Convert.ToInt32(Convertor.IsNull(cmbck.SelectedValue, "0"));
                    int t_ghdw = Yppc.SeekGhdwByKcid(yppch, t_deptid, InstanceForm.BDatabase,cjid);
                    ...
                    if (tt_ghdw != 0 && t_ghdw != 0)
                    {
                        if (tt_ghdw != t_ghdw)
                        {
                            string s_ghdw = Yp.SeekGhdw(t_ghdw, InstanceForm.BDatabase);
                            string ss_ghdw = Yp.SeekGhdw(tt_ghdw, InstanceForm.BDatabase);
                            if (MessageBox.Show(string.Format("该药品是从 [{0}] 采购的,您确认继续？", s_ghdw), "提示", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2) != DialogResult.Yes)
                            {
                                return;
                            }
                        }
            ...
            //if (Convertor.IsNull(row["批次号"], "") != "" && _menuTag.FunctionTag == "001")
            //{
            //    row["效期"] = dtpxq.Tag;
            //    row["批号"] = txtpch.Tag;
            //}
		...
		private void Getrow(DataRow row)
		{
            ...
            this.txtph.Tag = row["kcid"].ToString();  //kcph表中  kcid 
			...
			if (e.KeyChar==13 )
			{
				switch(control.Name)
				{
					...
					case "lblpfj":
						...
						break;
					case "txtjj":
                        if (txtjj.Text.Trim() == "") return;
						if (txtph.Enabled==true) txtph.Focus(); else butadd.Focus();
						break;
//					case "dtpxq":
...
//						break;
		...
		private void butsave_Click(object sender, System.EventArgs e)
		{
            ...
            {
                MessageBox.Show(err.Message,"",MessageBoxButtons.OK,MessageBoxIcon.Error); return;
            }
                #endregion
            ...
            try
			{
                ...
                string shdh = tb.Rows[0]["送货单号"].ToString();
...
//				DataTable tb=(DataTable)this.myDataGrid1.DataSource;
				...
				for(int i=0;i<=tb.Rows.Count-1;i++)
				{
                    ...
                    //药房采购入库 药库采购入库
                    if (_menuTag.Function_Name == "Fun_ts_yk_cgrk" || _menuTag.Function_Name == "Fun_ts_yk_cgrk_yf")
                    {
                        //if (bpcgl&&Convertor.IsNull(tb.Rows[i]["yppch"],"")=="")//进行批次管理才生成批次号
                        //{
					...
					if (isYk==true)
					{
                        ...
                        Yk_dj_djmx.SaveDJMX(new Guid(Convertor.IsNull(tb.Rows[i]["id"], Guid.Empty.ToString())),
							...
							_menuTag.FunctionTag.Trim(),
							"",
							Convert.ToString(tb.Rows[i]["送货单号"]),0,
...
//				string ssql="delete from yk_djmx where id="+Convert.ToInt64(Convertor.IsNull(datarow["id"],"0"))+" ";
                ...
                else //进行批次管理  则要在选择完批次之后更新显示进价
                {
                    ...
                    if (row != null)
                    {
                        ...
                        if (_menuTag.FunctionTag.ToString() == "002")
                        {
                            ...
                            this.txtpch.Tag = row["ypph"];//防止采购入库选择原有批次入库 时批号跟效期被修改
                            this.dtpxq.Tag = row["ypxq"];
                            this.txtph.Tag = row["kcid"];         //kcph表中 kcid 
                        }

                        if (_menuTag.Function_Name == "Fun_ts_yk_cgrk_th" || _menuTag.Function_Name == "Fun_ts_yk_cgrk_th_yf") //药库、药房退货
                        {
		...
		private void butsh_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
                ...
                if (YpConfig.是否药库(Convert.ToInt32(Convertor.IsNull(cmbck.SelectedValue, "0")), InstanceForm.BDatabase) == true)
                {
                    ...
                    Yk_dj_djmx.Shdj(new Guid(Convertor.IsNull(this.groupBox1.Tag, "0")), sDate, InstanceForm.BDatabase);
                }
                else
                {
                    YF_DJ_DJMX.Shdj(new Guid(Convertor.IsNull(this.groupBox1.Tag, "0")), sDate, InstanceForm.BDatabase);
                }
