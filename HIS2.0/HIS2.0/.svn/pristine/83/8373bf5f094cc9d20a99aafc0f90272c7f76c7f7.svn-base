...
{
    public partial class Frmzysqhz : Form
    {
        ...
        public Frmzysqhz(MenuTag menuTag, string chineseName, Form mdiParent)
        {
            InitializeComponent();
        ...
        private void btrefresh_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DataTable tb = InstanceForm.BDatabase.GetDataTable("SP_YJ_tj_zyhz", parameters, 60);
                Fun.AddRowtNo(tb);
        ...
        private void btApplyAffirm_Click(object sender, EventArgs e)
        {
            try
            {
               ...
               f = new TrasenFrame.Forms.FrmReportView(Dset, Constant.ApplicationDirectory + "\\Report\\YJ_项目汇总统计.rpt", parameters);
