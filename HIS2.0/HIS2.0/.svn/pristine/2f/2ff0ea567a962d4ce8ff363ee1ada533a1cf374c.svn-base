...
{
    public partial class Frmzysqhz_ys : Form
    {
        ...
        public Frmzysqhz_ys(MenuTag menuTag, string chineseName, Form mdiParent)
        {
            InitializeComponent();
        ...
        private void btrefresh_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DataTable tb = InstanceForm.BDatabase.GetDataTable("SP_YJ_tj_zyhz_ys", parameters, 60);
                Fun.AddRowtNo(tb);
