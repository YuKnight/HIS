...
namespace ts_PrintProcess
{
    ...
    public class Employee : IStdObject
    {
        ...
        /// </summary>
        public Employee(int employeeID, RelationalDatabase database)
            : this()
        {
            _database = database;
        ...
        /// <param name="database">数据库访问对象</param>
        /// </summary>
        public Employee(long employeeID, RelationalDatabase database)
            : this()
        {
            _database = database;
        ...
        {
            return GetNameById(employeeId, FrmMdiMain.Database);
        }
