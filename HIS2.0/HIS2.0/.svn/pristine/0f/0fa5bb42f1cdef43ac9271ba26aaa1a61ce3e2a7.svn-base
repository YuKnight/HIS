...
namespace TrasenClasses.DatabaseAccess
{
    ...
    /// INFORMIX 的摘要说明。
	/// </summary>
	public class INFORMIX: RelationalDatabase
	{
		/// <summary>
		/// 数据库平台名称
		/// </summary>
        protected const string VENDOR_NAME = "INFORMIX";
		/// <summary>
		/// 构造一OleDB
		/// </summary>
		public INFORMIX()
        ...
        private INFORMIX(string name, string connectionString)
		{
			...
			this.connection = new IBM.Data.Informix.IfxConnection (connectionString);
			this.Name = name;
		}
		/// <summary>
		/// 获取该对象副本
		...
		{
			IBM.Data.Informix.IfxCommandBuilder cb = new IBM.Data.Informix.IfxCommandBuilder((IBM.Data.Informix.IfxDataAdapter)_adapter);
		...
		public override int DoCommand(string commandText)
		{
			...
			if(isInTransaction) cmd.Transaction= (IBM.Data.Informix.IfxTransaction)transaction;
		...
		{
			return new IBM.Data.Informix.IfxParameter(parameterName,values);
		}
		/// <summary>
		/// 返回一个参数对象
		/// </summary>
		...
		{
			return new IBM.Data.Informix.IfxParameter(parameterName,(IBM.Data.Informix.IfxType)dataType,size);
		}
		/// <summary>
		/// 返回一个参数对象
		/// </summary>
		...
		{
			IBM.Data.Informix.IfxParameter para= new IBM.Data.Informix.IfxParameter(parameterName,(IBM.Data.Informix.IfxType)dataType,size);
			para.Value = values;
			return para;
		}
		/// <summary>
		...
		{
			IBM.Data.Informix.IfxParameter para= new IBM.Data.Informix.IfxParameter();
		...
		#region //返回一个IBM.Data.Informix.IfxDataAdapter
		/// <summary>
		///  返回一个IDataAdpter 
		/// </summary>
		/// <param name="cmd">IDbCommand对象</param>
		...
		public override void Initialize(string connectionString)
		{
			...
			try
			{
				...
				//获得连接
				IBM.Data.Informix.IfxConnection cnn=new IBM.Data.Informix.IfxConnection(cnnString);
			...
			catch(IBM.Data.Informix.IfxException e)
			{
		...
		{
			message = "";
			if (e is IBM.Data.Informix.IfxException)
			{
				IBM.Data.Informix.IfxException sqlErr = (IBM.Data.Informix.IfxException)e;
//				int j = 0;
