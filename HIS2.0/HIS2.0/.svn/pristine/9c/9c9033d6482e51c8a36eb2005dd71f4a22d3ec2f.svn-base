...
{
    public partial class Frmwjk_zffs : Form
    {
        private Form _mdiParent;
        private MenuTag _menuTag;
        private string _chineseName;

        public Frmwjk_zffs(MenuTag menuTag, string chineseName, Form mdiParent)
        {
            InitializeComponent();
            _menuTag = menuTag;
        ...
        private void buttj_Click(object sender, EventArgs e)
        {
            try
            {
               ...
               　TrasenFrame.Forms.FrmMdiMain.Database.AdapterFillDataSet("SP_MZSF_TJ_WJK_ZFFS", parameters, dset, "sfmx", 30);
