...
namespace ts_yj_mzyj				//★修改为约定的命名空间
{
	/// <summary>
	/// InstanceBForm 的摘要说明
	/// 实例化业务窗体
	...
	public class InstanceForm:IDllInformation
	{
		...
		public ObjectInfo GetDllInfo()
		{
            ...
            objectInfo.Name = "ts_yj_mzyj";						//★dll的文件名称,必须与命名空间保持一致
            objectInfo.Text = "门诊确费";						//★中文描述,可以为空
		...
		public ObjectInfo[] GetFunctionsInfo()
		{
			...
			objectInfos[0].Text="门诊费用确认";
            objectInfos[0].Remark = "门诊费用确认";

            objectInfos[1].Name = "Fun_ts_yj_mzyj_all";
            objectInfos[1].Text = "门诊费用确认(可退费)";
            objectInfos[1].Remark = "门诊费用确认(可退费)";

			objectInfos[1].Name = "Fun_ts_yj_mzyj_mag";
			objectInfos[1].Text = "门诊危机预警";
			objectInfos[1].Remark = "门诊危机预警";
			return objectInfos;
		}
		#endregion
