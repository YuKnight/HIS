...
namespace ts_mz_cfsh				//★修改为约定的命名空间
{
	/// <summary>
	/// InstanceBForm 的摘要说明
	/// 实例化业务窗体
	...
	public class InstanceForm:IDllInformation
	{
		...
		public ObjectInfo GetDllInfo()
		{
            ...
            objectInfo.Name = "ts_mz_cfsh";						//★dll的文件名称,必须与命名空间保持一致
			objectInfo.Text="门诊处方审核";								//★中文描述,可以为空
