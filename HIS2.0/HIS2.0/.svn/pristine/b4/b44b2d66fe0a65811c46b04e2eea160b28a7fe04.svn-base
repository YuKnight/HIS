    ...
    public class InstanceForm : IDllInformation
    {
        ...
        public void InstanceWorkForm()
        {
            ...
            switch (_functionName)
            {
                ...
                //    FrmICBCRec fir = new FrmICBCRec(_menuTag, _chineseName, _mdiParent);
                //    if (_mdiParent != null)
                //    {
                //        fir.WindowState = FormWindowState.Maximized;
                //        fir.MdiParent = _mdiParent;
                //    }
                //    fir.Show();
                //    break;
        ...
        {
            ObjectInfo[] objectInfos = new ObjectInfo[95];
