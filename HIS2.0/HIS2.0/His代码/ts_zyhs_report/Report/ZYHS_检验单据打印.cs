...
namespace ts_zyhs_report.Report {
    ...
    public class ZYHS_检验单据打印 : ReportClass {
    ...
    public class CachedZYHS_检验单据打印 : Component, ICachedReport {
        
        public CachedZYHS_检验单据打印() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            ZYHS_检验单据打印 rpt = new ZYHS_检验单据打印();
            rpt.Site = this.Site;
            return rpt;
        }
