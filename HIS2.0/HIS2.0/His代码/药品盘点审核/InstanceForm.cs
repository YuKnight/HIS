...
namespace ts_yp_pd				//★修改为约定的命名空间
{
    ...
    public class InstanceForm : IDllInformation, IInnerCommunicate
	{
		...
		public ObjectInfo GetDllInfo()
		{
			...
			objectInfo.Name="ts_yp_pd";						//★dll的文件名称,必须与命名空间保持一致
			objectInfo.Text="药品盘点单";								//★中文描述,可以为空
