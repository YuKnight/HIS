...
namespace ts_call
{
    ...
    /// 编写日期:2012-04-23 
    /// </summary>
    public class ts_call_vfd_TDKJ_BJ_SYRY : Icall
    {
        /// <summary>
        /// 通导语音报价器型号，1,4默认为1
        /// 
        ...
        public static bool call_yb = false;
            ...
            try
            {
                ...
                if (dmtype == DmType.应收)
                {
                    ...
                    else
                    {
                        ...
                        dsbdll(ncom, "EE");
                        dsbdll(ncom, "" + par[2].Substring(0, par[2].Length - 1) + "P");
                        //"&C21本院竭诚为您服务$
                        ...
                        ////第三行：卡支付，带“元”后缀 cwjz
                        //dsbdll(ncom, "$C3");
                        //dsbdll(ncom, "&C31卡余额：" + par[3] + "$"); //卡余额 "&C21" + callstring + "$"
                        //dsbdll(ncom, "EE");
                        //dsbdll(ncom, "" + par[2].Substring(0, par[2].Length - 1) + "P");
                        ////"&C21本院竭诚为您服务$
                        ////dsbdll(ncom, "&C11" + par[0].ToString() + "$");  //姓名
                ...
                if (dmtype == DmType.实收)
                {
                     ...
                     else
                     {
                         if (par.Length == 2)
                         {
                             dsbdll(ncom, "$C3");
                             // dsbdll(ncom, "" + par[4] + "Y");
                             dsbdll(ncom, "&C31卡支付：" + par[0] + "$");
                             dsbdll(ncom, "EF");
                             dsbdll(ncom, "" + par[0].Substring(0, par[0].Length - 1) + "P");
                             //add by tck 2013-11-21
                             dsbdll(ncom, "$C4");
                             dsbdll(ncom, "&C41卡余额：" + par[1] + "$");//卡余额支付
                             dsbdll(ncom, "EE");
                             dsbdll(ncom, "" + par[1].Substring(0, par[1].Length - 1) + "P");
                         }
                         else
                         {
                             dsbdll(ncom, "$5");
                ...
                if (dmtype == DmType.总费用)
                {
                    dsbdll(ncom, "&C21应收：" + callstring + "$"); //总费用
                    dsbdll(ncom, "D1");//EG
                    dsbdll(ncom, "" + callstring.Substring(0, callstring.Length - 1) + "P");
                }
            }
