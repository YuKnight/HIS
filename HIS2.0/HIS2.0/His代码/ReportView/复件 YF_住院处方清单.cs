...
namespace ts_Yk_ReportView {
    ...
    public class 复件_YF_住院处方清单 : ReportClass {
    ...
    public class Cached复件_YF_住院处方清单 : Component, ICachedReport {
        
        public Cached复件_YF_住院处方清单() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            复件_YF_住院处方清单 rpt = new 复件_YF_住院处方清单();
            rpt.Site = this.Site;
            return rpt;
        }
