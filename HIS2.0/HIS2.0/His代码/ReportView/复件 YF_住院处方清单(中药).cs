...
namespace ts_Yk_ReportView {
    ...
    public class 复件_YF_住院处方清单中药 : ReportClass {
        
        public 复件_YF_住院处方清单中药() {
        }
        
        public override string ResourceName {
            get {
                return "复件 YF_住院处方清单(中药).rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class Cached复件_YF_住院处方清单中药 : Component, ICachedReport {
        
        public Cached复件_YF_住院处方清单中药() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            复件_YF_住院处方清单中药 rpt = new 复件_YF_住院处方清单中药();
            rpt.Site = this.Site;
            return rpt;
        }
