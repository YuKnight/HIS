...
namespace ts_yj_jcwh				//★修改为约定的命名空间
{
	/// <summary>
	/// InstanceBForm 的摘要说明
	/// 实例化业务窗体
	...
	public class InstanceForm:IDllInformation
	{
		...
		public void InstanceWorkForm()
		{
			...
			switch(_functionName)
			{
                ...
                case "Fun_ts_yj_jcwh":
                    FrmOrderItemMzks FrmAction = new FrmOrderItemMzks();
					if (_mdiParent != null) {
		...
		public ObjectInfo GetDllInfo()
		{
            ...
            objectInfo.Name = "ts_yj_jcwh";						//★dll的文件名称,必须与命名空间保持一致
            objectInfo.Text = "医嘱项目门诊科室";						//★中文描述,可以为空
		...
		public ObjectInfo[] GetFunctionsInfo()
		{
            ...
            objectInfos[0].Name = "Fun_ts_yj_jcwh";
            objectInfos[0].Text = "医嘱项目门诊科室";
            objectInfos[0].Remark = "医嘱项目门诊科室"; 
			return objectInfos;
		}
		#endregion
