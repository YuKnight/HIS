...
namespace ts_yk_cgrk
{
	...
	public class Frmtitle : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            // butclose
            // 
            this.butclose.Location = new System.Drawing.Point(618, 6);
		...
		private void butnew_Click(object sender, System.EventArgs e)
		{
			...
			Frmyprk f=new Frmyprk(_menuTag,_chineseName,_mdiParent,tb);
			f.Show() ;
		}
		...
		private void butref_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				string _proName="";
                if (_menuTag.Function_Name == "Fun_ts_yk_cgrk" || _menuTag.Function_Name == "Fun_ts_yk_cgrk_th" || _menuTag.Function_Name == "Fun_ts_yk_cgrk_cx" || _menuTag.Function_Name == "Fun_ts_yk_cgrk_th_cx")
					_proName="sp_yk_selectDj";
				else
					_proName="sp_yf_selectDj";
