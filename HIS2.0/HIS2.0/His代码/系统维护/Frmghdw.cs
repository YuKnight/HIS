...
namespace ts_yp_xtwh
{
	...
	/// Form1 的摘要说明。
	/// </summary>
	public class Frmghdw : System.Windows.Forms.Form
	{
		...
		public Frmghdw(MenuTag menuTag,string chineseName,Form mdiParent)
		{
			//
			// Windows 窗体设计器支持所必需的
			//
		...
		private void AddData(string ss)
		{
			...
			if (ss.Trim()=="")
			{
				ssql="select 0 序号,ghdwmc 名称,pym 拼音码,wbm 五笔码,lxdh 联系电话,lxr 联系人,lxdz 地址,id from yp_GHDW";
			}
			else
			{
				ssql="select 0 序号,ghdwmc 名称,pym 拼音码,wbm 五笔码,lxdh 联系电话,lxr 联系人,lxdz 地址,id from yp_GHDW where pym like '"+txtdm.Text.Trim()+"%' or wbm like '"+txtdm.Text.Trim()+"%' or GHDWMC like '%"+txtdm.Text.Trim()+"%' ";
			}
		...
		private void butdel_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				if (tab.Rows.Count>0){MessageBox.Show("对不起，这个单位在系统中已经使用了，不能删除");return;}
