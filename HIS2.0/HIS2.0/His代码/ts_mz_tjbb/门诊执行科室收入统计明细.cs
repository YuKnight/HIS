...
{
    public partial class Frmzxkssrtj_mx : Form
    {
        ...
        public string ksdm = "";
        public Frmzxkssrtj_mx(MenuTag menuTag, string chineseName, Form mdiParent)
        {
            InitializeComponent();
        ...
        private void butexcel_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                DataTable tb = null;
                string ss = "";
                string dept = TreeDept.Nodes[0].Nodes[0].Text; // add by fangke 2014.11.18
                ...
                if (tabControl1.SelectedTab == tabPage4)// add by fangke 2014.11.18 
                {
                    tb = (DataTable)this.dataGridView4.DataSource;
                    ss = "执行科室项目确认人汇总表(" + dept + ")";
                }
