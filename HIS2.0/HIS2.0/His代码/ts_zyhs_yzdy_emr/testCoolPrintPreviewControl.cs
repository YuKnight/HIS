...
{
    /// <summary>
    /// Specifies the zoom mode for the <see cref="testCoolPrintPreviewControl"/> control.
    /// </summary>
    internal enum ZoomMode
    {
        ...
        TwoPages,
        /// <summary>
        /// Use the zoom factor specified by the <see cref="testCoolPrintPreviewControl.Zoom"/> property.
        /// </summary>
        Custom
    }
    ...
    /// </remarks>
    internal partial class testCoolPrintPreviewControl : UserControl
    {
        //-------------------------------------------------------------
        #region ** fields
        ...
        /// <summary>
        /// Initializes a new instance of a <see cref="testCoolPrintPreviewControl"/> control.
        /// </summary>
        public testCoolPrintPreviewControl()
        {
        ...
        {
            Image img = null;// GetImage(StartPage);
            if (img != null)
            {
        ...
        internal class DocumentPrinter : PrintDocument
        {
            ...
            public DocumentPrinter(testCoolPrintPreviewControl preview, int first, int last)
            {
