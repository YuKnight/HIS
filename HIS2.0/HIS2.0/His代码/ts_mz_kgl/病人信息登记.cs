    ...
    public partial class Frmbrkdj : Form
    {
        ...
        { 
            if (_menuTag.Function_Name != "hs" && _menuTag.Function_Name != "ys")
            {
                ...
                txtbrlxfs.Enabled = brlxfs == "true" ? true : false;
                ...
                txtjtdh.Enabled = jtdh == "true" ? true : false;
            ...
            if (_menuTag.Function_Name == "ys")
            {
                ...
                string brxm = ApiFunction.GetIniString("卡信息登记屏蔽项_医生站", "姓名", Constant.ApplicationDirectory + "//ClientWindow.ini");
                string xb = ApiFunction.GetIniString("卡信息登记屏蔽项_医生站", "性别", Constant.ApplicationDirectory + "//ClientWindow.ini");
                string nl = ApiFunction.GetIniString("卡信息登记屏蔽项_医生站", "年龄", Constant.ApplicationDirectory + "//ClientWindow.ini");
                txtbrxm.Enabled = brxm == "true" ? true : false;
                cmbxb.Enabled = xb == "true" ? true : false;
                txtnl.Enabled = nl == "true" ? true : false;
                rdocsrq.Enabled = nl == "true" ? true : false;//Add By Zj 2013-03-11
                ...
                string hk = ApiFunction.GetIniString("卡信息登记屏蔽项_医生站", "婚况", Constant.ApplicationDirectory + "//ClientWindow.ini");
                string gj = ApiFunction.GetIniString("卡信息登记屏蔽项_医生站", "国籍", Constant.ApplicationDirectory + "//ClientWindow.ini");
                string mz = ApiFunction.GetIniString("卡信息登记屏蔽项_医生站", "民族", Constant.ApplicationDirectory + "//ClientWindow.ini");
                string zy = ApiFunction.GetIniString("卡信息登记屏蔽项_医生站", "职业", Constant.ApplicationDirectory + "//ClientWindow.ini");
                cmbhk.Enabled = hk == "true" ? true : false;
                cmbgj.Enabled = gj == "true" ? true : false;
                cmbmz.Enabled = mz == "true" ? true : false;
                ...
                string brlxfs = ApiFunction.GetIniString("卡信息登记屏蔽项_医生站", "本人联系方式", Constant.ApplicationDirectory + "//ClientWindow.ini");
                string dzyj = ApiFunction.GetIniString("卡信息登记屏蔽项_医生站", "电子邮件", Constant.ApplicationDirectory + "//ClientWindow.ini");
                string yblx = ApiFunction.GetIniString("卡信息登记屏蔽项_医生站", "医保类型", Constant.ApplicationDirectory + "//ClientWindow.ini");
                string cbkh = ApiFunction.GetIniString("卡信息登记屏蔽项_医生站", "参保卡号", Constant.ApplicationDirectory + "//ClientWindow.ini");
                string sfzh = ApiFunction.GetIniString("卡信息登记屏蔽项_医生站", "身份证号", Constant.ApplicationDirectory + "//ClientWindow.ini");
                txtbrlxfs.Enabled = brlxfs == "true" ? true : false;
                txtdzyj.Enabled = dzyj == "true" ? true : false;
                cmbyblx.Enabled = yblx == "true" ? true : false;
                txtcbkh.Enabled = cbkh == "true" ? true : false;
                ...
                string csdz = ApiFunction.GetIniString("卡信息登记屏蔽项_医生站", "出生地址", Constant.ApplicationDirectory + "//ClientWindow.ini");
                string jtdz = ApiFunction.GetIniString("卡信息登记屏蔽项_医生站", "家庭住址", Constant.ApplicationDirectory + "//ClientWindow.ini");
                string jtdh = ApiFunction.GetIniString("卡信息登记屏蔽项_医生站", "家庭电话", Constant.ApplicationDirectory + "//ClientWindow.ini");
                string jtyb = ApiFunction.GetIniString("卡信息登记屏蔽项_医生站", "家庭邮编", Constant.ApplicationDirectory + "//ClientWindow.ini");
                string jtlxr = ApiFunction.GetIniString("卡信息登记屏蔽项_医生站", "家庭联系人", Constant.ApplicationDirectory + "//ClientWindow.ini");
                txtcsdz.Enabled = csdz == "true" ? true : false;
                txtjtdz.Enabled = jtdz == "true" ? true : false;
                txtjtdh.Enabled = jtdh == "true" ? true : false;
                txtjtyb.Enabled = jtyb == "true" ? true : false;
                ...
                string gzdw = ApiFunction.GetIniString("卡信息登记屏蔽项_医生站", "工作单位", Constant.ApplicationDirectory + "//ClientWindow.ini");
                string dwdh = ApiFunction.GetIniString("卡信息登记屏蔽项_医生站", "单位电话", Constant.ApplicationDirectory + "//ClientWindow.ini");
                string dwyb = ApiFunction.GetIniString("卡信息登记屏蔽项_医生站", "单位邮编", Constant.ApplicationDirectory + "//ClientWindow.ini");
                string dwlxr = ApiFunction.GetIniString("卡信息登记屏蔽项_医生站", "单位联系人", Constant.ApplicationDirectory + "//ClientWindow.ini");
                string dwdz = ApiFunction.GetIniString("卡信息登记屏蔽项_医生站", "单位地址", Constant.ApplicationDirectory + "//ClientWindow.ini");//Add By Zj 2013-03-11
                ...
                string lxrxm = ApiFunction.GetIniString( "卡信息登记屏蔽项_医生站" , "联系人姓名" , Constant.ApplicationDirectory + "//ClientWindow.ini" );
                string ybrdgx = ApiFunction.GetIniString( "卡信息登记屏蔽项_医生站" , "与病人的关系" , Constant.ApplicationDirectory + "//ClientWindow.ini" );
                string lxrdh = ApiFunction.GetIniString( "卡信息登记屏蔽项_医生站" , "联系人电话" , Constant.ApplicationDirectory + "//ClientWindow.ini" );
            ...
            ////年龄单位 Modify By Zj 2012-12-11 将代码转移到窗体构造时，代码放在这个位置将 不能正确获取病人的年龄 比如10小时。变成10岁
            //DataTable tb = new DataTable();
            //tb.Columns.Add("ID", Type.GetType("System.Int32"));
            //tb.Columns.Add("NAME", Type.GetType("System.String"));
            //DataRow row = tb.NewRow();
        ...
        private void butsave_Click(object sender, EventArgs e)
        {
            ...
            if (cfg3033.Config.Trim() != "")
            {
                ...
                {
                    if (strarr[i].ToString() == "1" && txtbrlxfs.Text.Trim()== "")
                    {
            ...
            if (txtsfzh.Text != "" && cfg3034.Config == "0")
            {
                ...
                //if (brxxid == Guid.Empty)
                //{
                //    bol_Re = !mz_kdj.SFZHCount(txtsfzh.Text, InstanceForm.BDatabase);
                //}
                //else
                //{
                //    bol_Re = !mz_kdj.SFZHCount(brxxid.ToString(), txtsfzh.Text, InstanceForm.BDatabase);
                //}
                //if (bol_Re)
                //{
                //    MessageBox.Show("身份证号:" + txtsfzh.Text + "已经拥有一张诊疗卡.不能继续办理!", "提示", MessageBoxButtons.OK, MessageBoxIcon.Information);
                //    txtsfzh.SelectAll();
                //    txtsfzh.Focus();
                //    return;
                //}
            ...
            //////如果是带金卡则提示输入卡金额
            ////if (card.bjebz == true && kdjid==Guid.Empty )
            ////{
            ////   if (MessageBox.Show(this, cmbklx.Text+"可以存入金额,现在需要存入金额吗?", "确认", MessageBoxButtons.YesNo) == DialogResult.Yes)
            ////   {
            ////            DlgInputBox dlgInputBox=new DlgInputBox("","请输入要存入的金额","存入金额");
            ////            dlgInputBox.ShowDialog();
            ////            if (DlgInputBox.DlgResult && DlgInputBox.DlgValue != "" && Convertor.IsNumeric(DlgInputBox.DlgValue) == false)
            ////            {
            ////                MessageBox.Show("请输入正确的金额", "错误", MessageBoxButtons.OK, MessageBoxIcon.Error);
            ////                return;
            ////            }
            ////            Crje = Convert.ToDecimal(Convertor.IsNull(DlgInputBox.DlgValue, "0"));
            ////    }
            ////}
            ...
            try
            {
                ...
                if (brxxid != null && brxxid != Guid.Empty)
                {
                    ...
                    if (tbmx.Rows.Count > 0)
                    {
                        ...
                        {
                            if (
                                (MessageBox.Show("该病人已经在住院存在信息，您确定要更改吗？\r\n  在住院的信息如下：\n  姓名【"+tbmx.Rows[0]["NAME"].ToString().Trim()+"】\n"
                ...
                YY_BRXX.BrxxDj(brxxid,
                  ...
                  txtzy.Tag==null?"":txtzy.Tag.ToString().Trim(),
                   ...
                   0, out brxxid, out err_code, out err_text, InstanceForm.BDatabase);
                if (brxxid == Guid.Empty || err_code != 0) throw new Exception(err_text);
                //Add By Zj 2012-07-16
                ...
                if (txtkh.Text.Trim() != "" && card.klx > 0)
                {
                    ...
                    if (kdjid == Guid.Empty || err_code != 0) throw new Exception(err_text);
                }
                ...
                if (Crje > 0)
                {
                    ...
                    if (kjeid == Guid.Empty || err_code != 0) throw new Exception(err_text);
                }
        ...
        private void FillBrxx(Guid brxxid)
        {
            ...
            if (brxx.Csrq.Trim() != "")
            {
                //                txtnl.Text = DateManager.DateToAge(Convert.ToDateTime(brxx.Csrq), TrasenFrame.Forms.FrmMdiMain.Database).AgeNum.ToString();
            ...
            cmbgj.Text = brxx.Gj == "-1" ? null : brxx.Gj;

                cmbmz.Text = brxx.Mz == "-1" ? null : brxx.Mz;
            //Modify by zouchihua 2013-5-7 通过编码获得
            try
            {
                cmbgj.SelectedValue = brxx.Gj == "-1" ? null : brxx.Gj;
                cmbmz.SelectedValue = brxx.Mz == "-1" ? null : brxx.Mz;

            }
            catch 
            {
                cmbgj.SelectedValue =-1;
                cmbmz.SelectedValue =-1;
            }
            try
            {
        ...
        private void SetHyzk(Age age)
        {
            ...
            {
                switch ( cfgAge.Config )
                {
                    case null:
                    case "":
                    case "0":
                        cmbhk.SelectedValue = "9";  //其他
                        break;
                    case "1":
                        if ( age.AgeNum < 18 )
                            cmbhk.SelectedValue = "9"; //18岁以下其他
                        else
                            cmbhk.SelectedValue = "2"; //18岁以上已婚, 
                        break;
                    case "2":
                        if ( age.AgeNum < 25 )
                            cmbhk.SelectedValue = "1"; //25岁以下未婚
                        else
                            cmbhk.SelectedValue = "2"; //25岁以上已婚
                        break;                    
                    default:
                        int num = Convert.ToInt32( cfgAge.Config );
                        if ( num >= 18 )
                        {
                            if ( age.AgeNum >= num )
                                cmbhk.SelectedValue = "2";
                            else
                                cmbhk.SelectedValue = "1";
                        }
                        break;
                }
        ...
        private void txtbrxm_Leave(object sender, EventArgs e)
        {
            if (txtbrxm.Text.Trim() != "")
            {
                ...
                int result = Convert.ToInt32(InstanceForm.BDatabase.GetDataResult(sql));
                if (result > 0)
                    lblts.Text = "在系统中已经有(" + result.ToString() + ")人";
                else
                    lblts.Text = "";               
            }
        }
