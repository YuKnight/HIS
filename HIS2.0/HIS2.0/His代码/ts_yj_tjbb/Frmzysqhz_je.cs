...
{
    public partial class  Frmzysqhz_je : Form
    {
        ...
        public Frmzysqhz_je(MenuTag menuTag, string chineseName, Form mdiParent)
        {
            InitializeComponent();
        ...
        private void btrefresh_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                DataTable tb = InstanceForm.BDatabase.GetDataTable("SP_YJ_tj_zyhz_je", parameters, 60);
                Fun.AddRowtNo(tb);
        ...
        private void btApplyAffirm_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                parameters[1].Value = "医技科室:" + cmbzxks.Text;
               ...
               f = new TrasenFrame.Forms.FrmReportView(Dset, Constant.ApplicationDirectory + "\\Report\\YJ_项目汇总统计_金额.rpt", parameters);
