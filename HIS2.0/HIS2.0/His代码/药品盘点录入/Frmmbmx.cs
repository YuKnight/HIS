...
namespace ts_yp_pdlr
{
	...
	/// Frmyprk 的摘要说明。
	/// </summary>
	public class Frmmbmx : System.Windows.Forms.Form
	{
		...
		private System.Windows.Forms.Label lblkcl;
		...
		public Frmmbmx(MenuTag menuTag,string chineseName,Form mdiParent)
		{
			InitializeComponent();
			_menuTag=menuTag;
		...
		private void InitializeComponent()
		{
            ...
            this.lblkcl = new System.Windows.Forms.Label();
            ...
            this.groupBox2.Controls.Add(this.lblkcl);
            ...
            // lblkcl
            // 
            this.lblkcl.BorderStyle = System.Windows.Forms.BorderStyle.Fixed3D;
            this.lblkcl.Font = new System.Drawing.Font("宋体", 9F, System.Drawing.FontStyle.Bold, System.Drawing.GraphicsUnit.Point, ((byte)(134)));
            this.lblkcl.Location = new System.Drawing.Point(64, 40);
            this.lblkcl.Name = "lblkcl";
            this.lblkcl.Size = new System.Drawing.Size(64, 20);
            this.lblkcl.TabIndex = 67;
            // 
            // label3
            // 
            ...
            this.myDataGrid2.Size = new System.Drawing.Size(162, 404);
            ...
            this.dataGridTextBoxColumn2.HeaderText = "修改时间";
            ...
            this.dataGridTextBoxColumn3.HeaderText = "修改人";
            ...
            this.tabPage2.Text = "没有列入模板的库存药品";
            this.tabPage2.UseVisualStyleBackColor = true;
            // 
            // groupBox3
            // 
            this.groupBox3.Controls.Add(this.myDataGrid3);
            ...
            this.myDataGrid3.Location = new System.Drawing.Point(3, 17);
            this.myDataGrid3.Name = "myDataGrid3";
            this.myDataGrid3.Size = new System.Drawing.Size(1016, 407);
            ...
            this.dataGridTextBoxColumn25.HeaderText = "库存量";
            ...
            // panel3
            // 
            this.panel3.Controls.Add(this.cmbck);
            this.panel3.Controls.Add(this.label4);
            this.panel3.Dock = System.Windows.Forms.DockStyle.Top;
            this.panel3.Location = new System.Drawing.Point(3, 17);
            this.panel3.Name = "panel3";
            this.panel3.Size = new System.Drawing.Size(162, 51);
            ...
            this.panel4.Size = new System.Drawing.Size(162, 404);
            ...
            this.cmbck.Location = new System.Drawing.Point(16, 21);
            this.cmbck.Name = "cmbck";
            this.cmbck.Size = new System.Drawing.Size(142, 20);
		...
		private void Frmmbmx_Load(object sender, System.EventArgs e)
		{
            ...
            AddTitle(Convert.ToInt32(Convertor.IsNull(cmbck.SelectedValue, "0")));
		...
		private void csyp(int ggid,int cjid)
		{
			try
			{
                ...
                if (YpConfig.是否药库(Convert.ToInt32(Convertor.IsNull(cmbck.SelectedValue, "0")),InstanceForm.BDatabase) == true)
                    tb = Yp.Selectkc(Convert.ToInt32(Convertor.IsNull(cmbck.SelectedValue, "0")), ydcj.CJID, "yk_kcmx", InstanceForm.BDatabase);
				else
                    tb = Yp.Selectkc(Convert.ToInt32(Convertor.IsNull(cmbck.SelectedValue, "0")), ydcj.CJID, "yf_kcmx", InstanceForm.BDatabase);
				if (tb.Rows.Count==0) return;
				this.lblkcl.Text=tb.Rows[0]["kcl"].ToString().Trim();
                this.lbldw.Text = Yp.SeekYpdw(Convert.ToInt32(tb.Rows[0]["zxdw"]), InstanceForm.BDatabase);
			}
			...
			try
			{
				...
				switch(control.TabIndex)
				{
					case 0:
                        ...
                        ssql = "select distinct a.ggid,cjid,0 rowno,s_ypspm,s_ypgg,s_sccj,s_ypdw,pfj,lsj,shh " +
                            " from yp_ypcjd a,yp_ypbm b where a.ggid=b.ggid    and a.n_ypzlx in(select ypzlx from yp_gllx where deptid=" + Convert.ToInt32(Convertor.IsNull(cmbck.SelectedValue, "0")) + ")  ";
		...
		private void txtdm_KeyUp(object sender, System.Windows.Forms.KeyEventArgs e)
		{
			try
			{
				...
				{
                    AddKcmx(Convert.ToInt32(Convertor.IsNull(cmbck.SelectedValue, "0")), txtdm.Text.Trim());
		...
		private bool DataBool(int cjid,out string bz)
		{
			...
			try
			{
				...
				if (B==true)
				{
                    string ssql = "select * from yp_pdmb a,yp_pdmbmx b where a.id=b.mbid and cjid=" + cjid + " and b.deptid=" + Convert.ToInt32(Convertor.IsNull(cmbck.SelectedValue, "0")) + "";
		...
		#region 填充数据
		//添加没有被加入模板的库存记录
		private void AddKcmx(long deptid,string s)
		{
			string ss="";
			if (s!="") 	
				ss=" and ggid in(select ggid from yp_ypbm where pym like '"+txtdm.Text.Trim().ToUpper()+"%' or wbm like '"+txtdm.Text.Trim().ToUpper()+"%'"+
					" or szm like '"+txtdm.Text.Trim().ToUpper()+"%' or ypbm like '%"+txtdm.Text.Trim()+"%')";
            ...
            ss = "SELECT  0 序号,yppm 品名,ypgg 规格,s_sccj 厂家,kcl 库存量,dbo.fun_yp_ypdw(zxdw) 单位,pfj 批发价,lsj 零售价,shh 货号,ggid,cjid  FROM " + tablename + " where (bdelete_kc=0 or (kcl<>0 and bdelete_kc=1)) and deptid=" + Convert.ToInt32(Convertor.IsNull(cmbck.SelectedValue, "0")) + "  and cjid not in(select cjid from yp_pdmbmx where deptid=" + Convert.ToInt32(Convertor.IsNull(cmbck.SelectedValue, "0")) + " ) " + ss.Trim();
			
			DataTable myTb=InstanceForm.BDatabase.GetDataTable(ss);
		...
		//刷新模板头
		private void AddTitle(long deptid)
		{
            string ssql = "SELECT  mbmc 模板名称, xgsj 修改时间, dbo.fun_getempname(xgy) 修改人,id FROM YP_PDMB where deptid=" + Convert.ToInt32(Convertor.IsNull(cmbck.SelectedValue, "0")) + " order by id";
		...
		public void Addmx(int mbid)
		{
            ...
            string ssql = "SELECT  0 序号,YPPM 品名, ypgg 规格, s_sccj 厂家, dbo.fun_yp_ypdw(ypdw) 单位, pfj 批发价,lsj 零售价,shh 货号,b.bz 描述,b.cjid FROM vi_yp_ypcd a,yp_pdmbmx b where a.cjid=b.cjid and b.deptid=" + Convert.ToInt32(Convertor.IsNull(cmbck.SelectedValue, "0")) + " and b.mbid=" + mbid + " order by id";
		...
		private void butdel_Click(object sender, System.EventArgs e)
		{
			try
			{
				...
				if(MessageBox.Show("您确定要删除第"+Convert.ToString((nrow+1))+"行吗 ？","询问窗",MessageBoxButtons.YesNo,MessageBoxIcon.Question,MessageBoxDefaultButton.Button2)==DialogResult.Yes)
				{
                    ...
                    string ssql = "delete from yp_pdmbmx where cjid=" + Convert.ToInt64(Convertor.IsNull(datarow["cjid"], "0")) + " and deptid=" + Convert.ToInt32(Convertor.IsNull(cmbck.SelectedValue, "0")) + "";
		...
		private void butsave_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
                ...
                this.AddTitle(Convert.ToInt32(Convertor.IsNull(cmbck.SelectedValue, "0")));
		...
		private void butdelmb_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				int mbid=Convert.ToInt32(Convertor.IsNull(this.groupBox5.Tag,"0"));
                YP_PDMB.DeleteMbmx(mbid, Convert.ToInt32(Convertor.IsNull(cmbck.SelectedValue, "0")), InstanceForm.BDatabase);
                YP_PDMB.DeleteMb(mbid, Convert.ToInt32(Convertor.IsNull(cmbck.SelectedValue, "0")), InstanceForm.BDatabase);
		...
		private void butmodifmc_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
                ...
                YP_PDMB.SaveMb(mbid, mbmc, "", "", "", InstanceForm.BCurrentUser.EmployeeId, DateManager.ServerDateTimeByDBType(InstanceForm.BDatabase).ToString(), InstanceForm.BCurrentUser.EmployeeId, Convert.ToInt32(Convertor.IsNull(cmbck.SelectedValue, "0")), out outmbid, InstanceForm.BDatabase);
