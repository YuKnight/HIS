...
{
    public partial class Frmzxkssrtj_mxByDate : Form
    {
        ...
        public  string ksdm = "";
        public Frmzxkssrtj_mxByDate(MenuTag menuTag, string chineseName, Form mdiParent)
        {
            InitializeComponent();
        ...
        private void butexcel_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                try
                {
                    ksmc = TreeDept.Nodes[0].Nodes[0].Text;
                }
                catch { }
                ...
                {
                    tb = (DataTable)this.dataGridView4.DataSource;
                    ss = "执行科室项目汇总表(" + ksmc + ")";
                }
        ...
        private void chkqfrq_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (this.chkqfrq.Checked)
            {
                this.chksfrq.Checked = false;
                this.list_datewhere.Clear();
                this.list_datewhere.Add(dtpqrrq1);
                this.list_datewhere.Add(dtpqrrq2);
            }
        }
        ...
        private void chksfrq_CheckedChanged(object sender, EventArgs e)
        {
            ...
            if (this.chksfrq.Checked)
            {
                this.chkqfrq.Checked = false;
                this.list_datewhere.Clear();
                this.list_datewhere.Add(this.dtpqrrq1);
                this.list_datewhere.Add(this.dtpqrrq2);
            }
        }
