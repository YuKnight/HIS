    ...
    public partial class Frmzkssrtj : Form
    {
        ...
        private void butexcel_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string swhere = "";
                if (chksfrq.Checked)
                    swhere = "收费日期从:" + dtp1.Value.ToString() + " 到:" + dtp2.Value.ToString() + xm + kstj + "  部门名称:" + cmbjgbm.Text;
                else
                    swhere = "确费日期从:" + dtpqrrq1.Value.ToString() + " 到:" + dtpqrrq2.Value.ToString() + xm + kstj + "  部门名称:" + cmbjgbm.Text;
        ...
        private void butprint_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string kstj = rbkdks.Checked == true ? "统计科室:开单科室" : "统计科室:执行科室";
                parameters[2].Text = "备注";
                parameters[2].Value = dtp1.Value.ToString() + " 到 " + dtp2.Value.ToString() + "  " + ssql + "   " + kstj + " 部门名称:" + cmbjgbm.Text + " 结算方式:" + jsfs;
