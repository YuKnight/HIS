...
namespace ts_zyhs_zxd {
    ...
    public class HIS_出院带药温馨提示 : ReportClass {
    ...
    public class CachedHIS_出院带药温馨提示 : Component, ICachedReport {
        
        public CachedHIS_出院带药温馨提示() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            HIS_出院带药温馨提示 rpt = new HIS_出院带药温馨提示();
            rpt.Site = this.Site;
            return rpt;
        }
