...
namespace ts_zyhs_zxd
{
	...
	public class InstanceForm : IDllInformation
	{
		...
		public ObjectInfo GetDllInfo()
		{
			...
			objectInfo.Text="执行单";
			objectInfo.Remark="执行单据打印（如输液卡、服药卡等）";
			return objectInfo;
		}
		/// <summary>
		/// 获得该Dll所有引出函数信息
		...
		public ObjectInfo[] GetFunctionsInfo()
		{
			...
			objectInfos[0].Text="执行单";
			objectInfos[0].Remark="执行单据打印（如输液卡、服药卡等）";

            objectInfos[1].Name = "Fun_ts_zyhs_zxd_allward";
            objectInfos[1].Text = "执行单(所有病区)";
            objectInfos[1].Remark = "执行单据打印（如输液卡、服药卡等）";

            objectInfos[2].Name = "Fun_ts_zyhs_zxd_zld";
            objectInfos[2].Text = "治疗单打印";
            objectInfos[2].Remark = "治疗单打印";
			return objectInfos;
		}
		#endregion
